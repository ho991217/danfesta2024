...
const data: Notice[] = [
  ...
  },
  {
    ...
    content: [
      ...
      '단국대학교 재학생 여러분 중 티켓팅에 우선적으로 성공하신 분들에 한하여 무대를 관람할 수 있게 단국존을 마련하였습니다.',
    ],
  },
  {
    id: 'notice-8',
  ...
  },
  {
    ...
    content: [
      ...
      '병으로 된 주류는 사고 예방을 위해 축준위로부터 제지할 수 있습니다.',
    ],
  },
  {
    id: 'notice-13',
