...
export default async function Ticket({ id, event, issued }: TicketInfo) {
  return (
    ...
    >
      <div className="bg-black relative h-[10rem] w-full overflow-hidden">
        <div className="w-full flex items-center justify-end pr-3 pt-1 absolute top-0 z-50">
          <TicketTool ticketId={id} />
        </div>
        <div className="absolute left-5 top-1/2 -translate-y-1/2 flex items-center gap-2 overflow-hidden">
      ...
      <div className="pt-5 px-5 flex w-full flex-col gap-2 z-0">
        <div>
